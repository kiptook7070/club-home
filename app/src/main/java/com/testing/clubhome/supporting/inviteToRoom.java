...
public class inviteToRoom extends ArrayAdapter<String> {
    ...
    public inviteToRoom(@NonNull Activity context, List<String> userList,String roomId) {
    ...
    public View getView(final int position , View view, ViewGroup parent){
        ...
        club = firebaseDatabase.getReference("RoomsInfo").child(roomId);
    ...
    private void addInvitation(String s) {
        //Noifying
        String title= "Room"+" - "+roomId;
        String body= user.getDisplayName()+" has invited you to join the room " +roomId;
