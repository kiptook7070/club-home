...
public class inviteRoomlist extends ArrayAdapter<String> {
    ...
    public inviteRoomlist(@NonNull Activity context, List<String> userList,String forThePosition,String clubId,String clubName) {
    ...
    public View getView(final int position , View view, ViewGroup parent){
        ...
        club = firebaseDatabase.getReference("RoomsInfo").child(clubId);
    ...
    private void addInvitation(String s) {
        //Noifying
        String title= "Room"+" - "+clubId;
        String body= user.getDisplayName()+" has invited you to join the room " +clubName;
